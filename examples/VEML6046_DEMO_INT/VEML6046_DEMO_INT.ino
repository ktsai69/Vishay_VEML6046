...
/*
 * This demo requests to cnnect the INT pin of VEML6046 to Digital Pin 2. 
 */
...
void setup()
{
  ...
  veml6046.ALS_INT_EN_with_threshold(thd_percent);
...
void loop()
{
  if (isr_triggered)
  {
    ...
    if (veml6046.read_ALS_INT(&int_flag) &&
        (int_flag & (veml6046.ALS_IF_H | veml6046.ALS_IF_L)))
    {
      uint16_t als;
